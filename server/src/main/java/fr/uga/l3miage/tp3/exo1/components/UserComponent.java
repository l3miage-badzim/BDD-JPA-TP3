...
@Component
@RequiredArgsConstructor // that's LOMBROK magic automatically generate constructor for our class properties pour l'injection de dependance
public class UserComponent {
    ...
    public UserEntity createUser(String name, String mail) {
    ...
    public Set<UserEntity> getUserIsInDomaine(String domaine) {
